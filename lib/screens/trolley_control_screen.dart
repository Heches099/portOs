...
class TrolleyControlScreen extends StatefulWidget {
  const TrolleyControlScreen({super.key});

  @override
  State<TrolleyControlScreen> createState() => _TrolleyControlScreenState();
}
...
class _TrolleyHeading extends StatelessWidget {
  const _TrolleyHeading({required this.isDark});
    ...
    return Row(
      children: [
        Container(
          ...
          child: const Icon(Icons.linear_scale_rounded, color: Color(0xFF2DD4BF), size: 22),
        ),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Trolley traverse, hoist lift, and electromagnet for the Crane-01 trolley unit.',
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              'Trolley telemetry unavailable: $error',
